  ...
  return (
    <main className="min-h-[calc(100vh-64px)] bg-gray-50 p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Manage Automation</h1>
          <p className="text-gray-500">Kelola workflow automation n8n Anda</p>
        </div>
        <Link to="/dashboard/automation/deploy" className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition-colors shadow-sm">
          <Plus size={18} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-gray-500 text-sm font-medium">Total Automation</h3>
            <div className="p-2 bg-blue-50 text-blue-600 rounded-lg">
              <Zap size={20} />
            </div>
          </div>
          <div className="flex items-end gap-2">
            <span className="text-3xl font-bold text-gray-900">{automationServices.length}</span>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-gray-500 text-sm font-medium">Active Automation</h3>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
          ...
          <div className="flex items-end gap-2">
            ...
            <span className="text-green-600 text-xs font-medium mb-1">All services running</span>
          </div>
        </div>
      </div>
              ...
              <div className="p-6">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-6">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="hidden sm:flex h-12 w-12 items-center justify-center rounded-lg bg-pink-50 text-pink-600">
                      <Clock size={24} />
                    </div>
                    <div>
